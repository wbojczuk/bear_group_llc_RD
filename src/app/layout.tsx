...
const secondaryFont = Roboto({ subsets: ['latin'], weight: ["100", "300", "400", "500", "700", "900"], display: "swap", variable: "--secondary-font" })
const primaryFont = Nunito({ subsets: ['latin'], weight: ["200", "300", "400", "500", "700", "800", "900"], display: "swap", variable: "--primary-font" })
